...
| :--- | :--- |
| **Cloud Platforms** | AWS (EC2, S3, VPC, IAM, RDS, Route53, CloudFront) |
| **Networking** | TCP/IP, DNS, OSPF, VLANs, Firewalls, Cisco Packet Tracer |
| **IaC & Automation** | Terraform, AWS CloudFormation, Ansible (Beginner) |
| **DevOps & Tools** | Docker, Kubernetes, Linux (Ubuntu/CentOS), Git & GitHub |
...
[<img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" />](mailto:Kingflirckz22@gmail.com)

---

### ⚡ Fun Fact
I believe that "Everything fails, all the time" — which is why I'm obsessed with building for high availability and fault tolerance!
